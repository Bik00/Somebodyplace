...
<body>
	<div id="main">
		<div id="main_header">
							...
							<c:forEach items="${mainIssue}" var="issue" varStatus="status">
								...
								<div class="mainissue_border">
									...
									<div class="mainissue_profile">
										...
										<br> <span style="margin-left: -170px !important;"></span>
										<span><h5 class="geoOfIssue">
												<%-- *${issue.address} --%>
												<fmt:formatDate pattern="yyyy-MM-dd HH:mm"
													value="${issue.post_time}" />
												<br>
												<img src="./resources/img/radiusForIssue.png"
													style="width: 20px; height: 20px;"><input
													type="hidden" value="${issue.distance}"
													class="index_meterWillChange">
												<p style="display: inline;"></p>
												<br>
											</h5></span>
										<table style="margin-right: 10px; float: right;">
											<tr>
												<td><button data-chatBtn="${issue.issue_code}"
														class="btn btn-default requestChat">1:1대화신청</button></td>
											</tr>
			...
			<div id="main_info">
				<span class="main_member"> <c:if test="${nickname != null }">         
        			...
        			<input type="text" style="display: none"
							value="${member_code}" class="member_code">
						<input type="text" style="display: none" value="${member_email}"
							class="member_email">
						<input type="text" style="display: none" value="${Cmember_code}"
							class="Cmember_code">
					...
					</c:if> <span class="main_PlaceBtn">플레이스</span>
				</span>
			</div>
			<div id="main_search">
			...
			<div id="main_geolocation">
				...
				<div id="index_findeGeo">
					<input type="text" id="index_searchMyGeolocation"
						...
						onkeypress="findGeoAddr(event, this.value)"> <input
						type="button" id="index_searchAutoGeolocation"
						class="btn btn-default" value="현재위치 자동검색" onclick="geoFindMe()">
				</div>
				<input type="button" value="위치 찾기"
					class="btn btn-default index_findAboutGeo">
				<div id="resultOfGeo">
					<ul style='list-style: none; padding-left: 0 !important;'></ul>
				</div>
			</div>
			<!-- 타임라인 기능  -->
			<div class="Somebody_timeline">
				<img src="./resources/img/somebody_timeline.png"
			...
			<c:if test="${nickname!= null && applogin == null}">
				<div class="chatImg">
					<img src="./resources/img/chat.png"> <span
						class="badge chat_balloons"></span>
				</div>
					...
					<div id="layer2" class="pop-layer">
						<div class="pop-container">
							<div class="pop-conts">
								<!--content //-->
								<p class="ctxt mb20">
									이슈가 도착하였습니다!<br> 맛있는 사과 가게가 오픈했어요~<br> 다들 한번씩 구경하러
									오세요!<br>
									<br> 대구광역시 북구 복현로 37-2
								</p>

								<div class="btn-r">
									<br> <a href="#" class="cbtn">확인</a> <a href="#"
										class="cbtn">닫기</a>
								</div>
								<!--// content-->
							</div>
			...
			<div class="chatDiv">
				<span class="backChat glyphicon glyphicon-chevron-left"></span> <span
					class="closeChat glyphicon glyphicon-remove"></span>
							...
							<div class="chat_card">
								<div class="chat_menu front">
									...
									<table class="chat_moreTable" id="helpChat">
										<tr>
											<td><img src="./resources/img/chat_helpChat.png"
												class="chat_menu_img"></td>
										</tr>
										<tr>
											<td>채팅 도움말</td>
										</tr>
									...
									<table class="chat_moreTable" id="lookOtherItem">
										<tr>
											<td><img src="./resources/img/chat_lookOtherItem.png"
												class="chat_menu_img"></td>
										</tr>
										<tr>
											<td>상대 상품조회</td>
									...
									<table class="chat_moreTable" id="lookMyItem">
										<tr>
											<td><img src="./resources/img/chat_lookMyItem.png"
												class="chat_menu_img"></td>
										</tr>
										<tr>
											<td>내 상품조회</td>
									...
									<table class="chat_moreTable" id="addAuto">
										<tr>
											<td><img src="./resources/img/chat_addAuto.png"
												class="chat_menu_img"></td>
										</tr>
										<tr>
											<td>예약어 추가</td>
									...
									<table class="chat_moreTable" id="chatRoute">
										<tr>
											<td><img src="./resources/img/chat_route.png"
												class="chat_menu_img"></td>
										</tr>
										<tr>
											<td>상대 주소검색</td>
									...
									<table class="chat_moreTable" id="exitChat">
										<tr>
											<td><img src="./resources/img/chat_exitChat.png"
												class="chat_menu_img"></td>
										</tr>
										<tr>
											<td>대화방 나가기</td>
								...
								<div class="chat_menu back"></div>
							</div>
						</div>
						<div class="comment">
							<input type="text" class="writeComment" id="writeComment"
								name="writeComment" placeholder="채팅 입력하세요"
								onkeypress="enter(event, this.value)" />
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close closeChattingModal"
				...
				<div class="modal-body bodyChattingModal">
					...
					<table class="table" id="chat_optionTable">
						<tr>
							<td id="chat_optionName"><h4>
									<b>옵션 이름</b>
								</h4></td>
							<td id="chat_optionSelect"><h4>
									<b>세부 옵션</b>
								</h4></td>
							<td id="chat_optionAdditionalPrice"><h4>
									<b>세부 옵션 추가 가격</b>
								</h4></td>
						</tr>
					...
					<table class="table">
						<tr>
							<td>
								<div class="checkbox">
									<label><input type="checkbox" id="cart_myInfo">
										기존 정보와 동일</label>
								</div>
								...
								<div class="form-group">
									<label class="control-label col-sm-2">요청<br>사항
									</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									<label class="control-label col-sm-2">유형<br>선택
									</label>
									<div class="radio col-sm-10 chat_requestType"></div>
									<input type="hidden" id="chat_TotalType">
								</div> <br> <br>
								<div class="form-group">
									<label class="control-label col-sm-2">결제<br>수단
									</label>
									<div class="radio col-sm-10">
										<label> <input type="radio" id="inlineCheckbox1"
											...
											휴대폰 결제
										</label> <label> <input type="radio" id="inlineCheckbox4"
											value="option5" name="text^^"> 현장 지불
										</label>
									</div>
								</div>
							</td>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default confrimChattingModal"
						data-dismiss="modal">신청하기</button>
					<button type="button" class="btn btn-default closeChattingModal"
	...
	<c:if test="${isProduct == 'true'}">
		<div id="isProduct_mySidenav" class="isProduct_sidenav" style='display:none'>
	...
	<div class="modal fade" id="chatRouteModal" role="dialog">
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close closeChatRouteModal"
						data-dismiss="modal">&times;</button>
					<h4 class="modal-title">SOMEBODY 알림창</h4>
				</div>
